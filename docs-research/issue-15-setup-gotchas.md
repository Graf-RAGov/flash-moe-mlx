> Copied from https://github.com/danveloper/flash-moe/issues/15 on 2026-04-17. License: governed by upstream issue terms.

---

# Issue #15: I did get it working, with a lot of pain, if your interested here's a readme I had claud crank out capturing the gotchas.

**Opened by:** scottpeterman | **Created:** 2026-03-28 | **State:** open | **Reactions:** +4, :heart: 1
...
tok_path = os.path.expanduser('~/qwen35-397b-4bit/tokenizer.json')
...
```bash
cd ~/flash-moe/metal_infer
python3 ../repack_experts.py --index ~/flash-moe/expert_index.json
```
...
find ~/qwen35-397b-4bit -maxdepth 1 -mindepth 1 ! -name packed_experts -exec rm -rf {} +
```
...
### Comment by HIGGS317 (2026-03-31)
...
### Comment by rafaelkupper (2026-03-31)

Thanks! Got it running on a MBP M4 Pro 48GB at 3.1 tok/s.

---

### Comment by Shivox (2026-04-08)
...
### Comment by Proryanator (2026-04-14)
